...
FMK UI family loaded from root file `UI12.FMK`, `UI14.FMK` or `UI16.FMK`.
Family 0 ignores the stored 12/14/16 size. On F411/UC1609
...
12/14/17 px, or selects an external FMK whose height exactly equals the stable
12/14/16 value. INFO supplies ascent, descent, interline gap and real `height`
...
FMK arena; after unmount the resident reloads and revalidates it before the
service exposes family 3 again.
