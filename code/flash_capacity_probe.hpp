...
// проверяет физическую границу, прежде чем C6 доверится результату.
...
// Вызывать лишь при отсутствии обеих действительных копий локатора C6.
...
bool detect(RawFlash& flash, u32 reported_capacity, u32& capacity,
  ...
  // C6 должна использовать всё физически адресуемое устройство. Поддерживается
