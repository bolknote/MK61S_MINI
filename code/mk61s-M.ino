...
void  loop() {
  ...
  // дополнительно опрашиваем матрицу из системного цикла. Работающий
  // калькулятор получает все клавиши; замороженный trap — только управление
  // M61. Сам сканер ограничивает частоту до безопасного периода сигнала.
  if(m61_text::active()) {
