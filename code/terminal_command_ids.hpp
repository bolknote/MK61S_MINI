...
enum : u8 {
  ...
  CMD_SET_CODE, CMD_POKE, CMD_DFU, CMD_DUMP, CMD_PUB, CMD_STACK,
  CMD_KBD, CMD_CMD, CMD_CLEAR, CMD_RING, CMD_RUN, CMD_OPEN,
  CMD_FORMAT_STORAGE, CMD_INS, CMD_HELP, CMD_HISTORY,
  ...
  CMD_USB_SCREEN, CMD_PRINT, CMD_MEASURE, CMD_WAIT, CMD_RET, CMD_REINIT, CMD_PROFILE,
  CMD_CRASH, CMD_WATCHDOG, CMD_MPU, CMD_MEMORY, CMD_DISPLAY, CMD_IDENTITY,
  CMD_BENCHMARK, CMD_ALARM, CMD_ENCODING
};
