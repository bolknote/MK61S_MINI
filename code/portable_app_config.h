...
#error "MK61_ENABLE_PORTABLE_APPS was removed; ABI 6 is mandatory"
#endif

#define MK61_PORTABLE_APP_ADDRESS 0x20000000UL
/* ABI 6 unifies System and ordinary APP startup and makes every text argument
 * M8: INITIALIZE always receives
 * mk61_app_api*, image CRC and Kind.  ABI 2/3/4 are deliberately rejected. */
#define MK61_CURRENT_APP_ABI 6U
