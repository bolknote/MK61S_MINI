...
23.09.2026. Исправления целей и ускорение боя. Этот документ описывает собранную
...
Занято **3183 из 3584 байт**, свободен 401. Число включает код,
...
| B02 | 0224–0335 | display / trade |
| B03 | 0336–0447 | glyphs / messages |
| B04 | 0448–0559 | arithmetic / combat views |
| B05 | 0560–0671 | world |
...
| B27 COMBAT | тип врага, корпус, дистанция, последний манёвр, ход, цель, заряд, сила врага, база лазера |
| B28 DRONES | корпуса пяти дронов, всего выпущено, живых сейчас, два резерва |
| B29 FRAME | четыре слова нового кадра, четыре последнего кадра, постоянное слово СП |
...
B29 хранит новый и предыдущий кадры. Пока страница открыта, её R0…R3
...
внутри ядра. Затем R0…R3 копируются в R4…R7 для сохранения последнего кадра.
...
игровых страниц и кадры совпали с host-драйвером; [измерения и исправления](Segment-Elite-fixes-2026-09-23.md)
