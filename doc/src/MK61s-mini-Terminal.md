...
блок нужного размера из общего 20-КиБ пула. Для ABI 4 выполняются ZX0,
обратный BCJ при наличии флага и проверка/применение релокаций. Прежний
ABI 3 использует фиксированный адрес; точный resident и payload `NONE`
поддерживаются в ABI 2.
Старый C5-файл
